...
const clientMenuItems = [
  ...
  { icon: FolderOpen, label: "Categorias", path: "/client/categories" },
  { icon: ShoppingBag, label: "Produtos", path: "/client/products" },
  { icon: Store, label: "Vitrine", path: "/client/vitrine" },
